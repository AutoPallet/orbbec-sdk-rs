...
fn get_builder(target: &str) -> bindgen::Builder {
...
pub fn generate_properties(args: GenerateArgs) {
    ...
    let struct_bindings = bindgen::Builder::default()
        .header("OrbbecSDK/include/libobsensor/ObSensor.h")
