...
const _: () = {
    ...
    ["Offset of field: OBDataChunk::full_data_size"]
        [::std::mem::offset_of!(OBDataChunk, full_data_size) - 16usize];
};
#[doc = "@brief Structure for transmitting data blocks"]
pub type ob_data_chunk = OBDataChunk;
#[doc = "@brief Coefficients of the global-timestamp linear fit `host_us = a * device_us + b`.\n\n Returned by ob_device_get_global_timestamp_linear_param. All fields are zero\n until the fitter has collected enough samples to fit (typically a few\n seconds after enabling the global timestamp)."]
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
pub struct OBLinearFuncParam {
    #[doc = "Slope of the fit"]
    pub coefficient_a: f64,
    #[doc = "Intercept of the fit"]
    pub constant_b: f64,
    #[doc = "Most recent device-time sample fed into the fit (x)"]
    pub check_data_x: u64,
    #[doc = "Host-time partner of check_data_x (y)"]
    pub check_data_y: u64,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of OBLinearFuncParam"][::std::mem::size_of::<OBLinearFuncParam>() - 32usize];
    ["Alignment of OBLinearFuncParam"][::std::mem::align_of::<OBLinearFuncParam>() - 1usize];
    ["Offset of field: OBLinearFuncParam::coefficient_a"]
        [::std::mem::offset_of!(OBLinearFuncParam, coefficient_a) - 0usize];
    ["Offset of field: OBLinearFuncParam::constant_b"]
        [::std::mem::offset_of!(OBLinearFuncParam, constant_b) - 8usize];
    ["Offset of field: OBLinearFuncParam::check_data_x"]
        [::std::mem::offset_of!(OBLinearFuncParam, check_data_x) - 16usize];
    ["Offset of field: OBLinearFuncParam::check_data_y"]
        [::std::mem::offset_of!(OBLinearFuncParam, check_data_y) - 24usize];
};
#[doc = "@brief Coefficients of the global-timestamp linear fit `host_us = a * device_us + b`.\n\n Returned by ob_device_get_global_timestamp_linear_param. All fields are zero\n until the fitter has collected enough samples to fit (typically a few\n seconds after enabling the global timestamp)."]
pub type ob_linear_func_param = OBLinearFuncParam;
...
pub struct OBAccelIntrinsic {
    ...
    pub scale_misalignment: [f64; 9usize],
    #[doc = "linear temperature drift coefficient"]
    pub temp_slope: [f64; 9usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ...
    ["Offset of field: OBAccelIntrinsic::noise_density"]
        [::std::mem::offset_of!(OBAccelIntrinsic, noise_density) - 0usize];
    ["Offset of field: OBAccelIntrinsic::random_walk"]
        [::std::mem::offset_of!(OBAccelIntrinsic, random_walk) - 8usize];
    ["Offset of field: OBAccelIntrinsic::reference_temp"]
        [::std::mem::offset_of!(OBAccelIntrinsic, reference_temp) - 16usize];
    ...
    ["Offset of field: OBAccelIntrinsic::scale_misalignment"]
        [::std::mem::offset_of!(OBAccelIntrinsic, scale_misalignment) - 72usize];
    ["Offset of field: OBAccelIntrinsic::temp_slope"]
        [::std::mem::offset_of!(OBAccelIntrinsic, temp_slope) - 144usize];
};
#[doc = "@brief Structure for accelerometer intrinsic parameters"]
...
const _: () = {
    ...
    ["Offset of field: OBGyroIntrinsic::noise_density"]
        [::std::mem::offset_of!(OBGyroIntrinsic, noise_density) - 0usize];
    ["Offset of field: OBGyroIntrinsic::random_walk"]
        [::std::mem::offset_of!(OBGyroIntrinsic, random_walk) - 8usize];
    ["Offset of field: OBGyroIntrinsic::reference_temp"]
        [::std::mem::offset_of!(OBGyroIntrinsic, reference_temp) - 16usize];
    ["Offset of field: OBGyroIntrinsic::bias"]
        [::std::mem::offset_of!(OBGyroIntrinsic, bias) - 24usize];
    ["Offset of field: OBGyroIntrinsic::scale_misalignment"]
        [::std::mem::offset_of!(OBGyroIntrinsic, scale_misalignment) - 48usize];
    ["Offset of field: OBGyroIntrinsic::temp_slope"]
        [::std::mem::offset_of!(OBGyroIntrinsic, temp_slope) - 120usize];
};
#[doc = "@brief Structure for gyroscope intrinsic parameters"]
...
const _: () = {
    ...
    ["Offset of field: OBCameraDistortion::k_1"]
        [::std::mem::offset_of!(OBCameraDistortion, k_1) - 0usize];
    ["Offset of field: OBCameraDistortion::k_2"]
        [::std::mem::offset_of!(OBCameraDistortion, k_2) - 4usize];
    ["Offset of field: OBCameraDistortion::k_3"]
        [::std::mem::offset_of!(OBCameraDistortion, k_3) - 8usize];
    ["Offset of field: OBCameraDistortion::k_4"]
        [::std::mem::offset_of!(OBCameraDistortion, k_4) - 12usize];
    ["Offset of field: OBCameraDistortion::k_5"]
        [::std::mem::offset_of!(OBCameraDistortion, k_5) - 16usize];
    ["Offset of field: OBCameraDistortion::k_6"]
        [::std::mem::offset_of!(OBCameraDistortion, k_6) - 20usize];
    ["Offset of field: OBCameraDistortion::p_1"]
        [::std::mem::offset_of!(OBCameraDistortion, p_1) - 24usize];
    ["Offset of field: OBCameraDistortion::p_2"]
        [::std::mem::offset_of!(OBCameraDistortion, p_2) - 28usize];
...
pub struct OBCameraParam {
    ...
    pub depth_intrinsic: OBCameraIntrinsic,
    #[doc = "Color camera internal parameters"]
    pub rgb_intrinsic: OBCameraIntrinsic,
    #[doc = "Depth camera distortion parameters"]
    pub depth_distortion: OBCameraDistortion,
    #[doc = "Color camera distortion parameters"]
    pub rgb_distortion: OBCameraDistortion,
...
const _: () = {
    ...
    ["Offset of field: OBCameraParam::depth_intrinsic"]
        [::std::mem::offset_of!(OBCameraParam, depth_intrinsic) - 0usize];
    ["Offset of field: OBCameraParam::rgb_intrinsic"]
        [::std::mem::offset_of!(OBCameraParam, rgb_intrinsic) - 20usize];
    ["Offset of field: OBCameraParam::depth_distortion"]
        [::std::mem::offset_of!(OBCameraParam, depth_distortion) - 40usize];
    ["Offset of field: OBCameraParam::rgb_distortion"]
        [::std::mem::offset_of!(OBCameraParam, rgb_distortion) - 76usize];
    ["Offset of field: OBCameraParam::transform"]
        [::std::mem::offset_of!(OBCameraParam, transform) - 112usize];
    ["Offset of field: OBCameraParam::is_mirrored"]
        [::std::mem::offset_of!(OBCameraParam, is_mirrored) - 160usize];
};
#[doc = "@brief Structure for camera parameters"]
...
pub struct OBPresetResolutionConfig {
    ...
    pub ir_decimation_factor: ::std::os::raw::c_int,
    #[doc = "depth decimation factor"]
    pub depth_decimation_factor: ::std::os::raw::c_int,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ...
    ["Offset of field: OBPresetResolutionConfig::ir_decimation_factor"]
        [::std::mem::offset_of!(OBPresetResolutionConfig, ir_decimation_factor) - 4usize];
    ["Offset of field: OBPresetResolutionConfig::depth_decimation_factor"]
        [::std::mem::offset_of!(OBPresetResolutionConfig, depth_decimation_factor) - 8usize];
};
...
pub struct OBDeviceTemperature {
    ...
    pub ir_left_temp: f32,
    #[doc = "Right IR temperature"]
    pub ir_right_temp: f32,
    #[doc = "MX6600 top temperature"]
    pub chip_top_temp: f32,
    #[doc = "MX6600 bottom temperature"]
    pub chip_bottom_temp: f32,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ...
    ["Offset of field: OBDeviceTemperature::cpu_temp"]
        [::std::mem::offset_of!(OBDeviceTemperature, cpu_temp) - 0usize];
    ["Offset of field: OBDeviceTemperature::ir_temp"]
        [::std::mem::offset_of!(OBDeviceTemperature, ir_temp) - 4usize];
    ["Offset of field: OBDeviceTemperature::ldm_temp"]
        [::std::mem::offset_of!(OBDeviceTemperature, ldm_temp) - 8usize];
    ["Offset of field: OBDeviceTemperature::main_board_temp"]
        [::std::mem::offset_of!(OBDeviceTemperature, main_board_temp) - 12usize];
    ["Offset of field: OBDeviceTemperature::tec_temp"]
        [::std::mem::offset_of!(OBDeviceTemperature, tec_temp) - 16usize];
    ["Offset of field: OBDeviceTemperature::imu_temp"]
        [::std::mem::offset_of!(OBDeviceTemperature, imu_temp) - 20usize];
    ["Offset of field: OBDeviceTemperature::rgb_temp"]
        [::std::mem::offset_of!(OBDeviceTemperature, rgb_temp) - 24usize];
    ["Offset of field: OBDeviceTemperature::ir_left_temp"]
        [::std::mem::offset_of!(OBDeviceTemperature, ir_left_temp) - 28usize];
    ["Offset of field: OBDeviceTemperature::ir_right_temp"]
        [::std::mem::offset_of!(OBDeviceTemperature, ir_right_temp) - 32usize];
    ["Offset of field: OBDeviceTemperature::chip_top_temp"]
        [::std::mem::offset_of!(OBDeviceTemperature, chip_top_temp) - 36usize];
    ["Offset of field: OBDeviceTemperature::chip_bottom_temp"]
        [::std::mem::offset_of!(OBDeviceTemperature, chip_bottom_temp) - 40usize];
};
#[doc = "@brief Temperature parameters of the device (unit: Celsius)"]
...
pub struct OBDisparityParam {
    ...
    pub pack_mode: u8,
    pub disp_offset: f32,
    pub invalid_disp: i32,
    pub disp_int_place: i32,
    pub is_dual_camera: u8,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ...
    ["Offset of field: OBDisparityParam::bit_size"]
        [::std::mem::offset_of!(OBDisparityParam, bit_size) - 28usize];
    ["Offset of field: OBDisparityParam::unit"]
        [::std::mem::offset_of!(OBDisparityParam, unit) - 29usize];
    ["Offset of field: OBDisparityParam::min_disparity"]
        [::std::mem::offset_of!(OBDisparityParam, min_disparity) - 33usize];
    ["Offset of field: OBDisparityParam::pack_mode"]
        [::std::mem::offset_of!(OBDisparityParam, pack_mode) - 37usize];
    ["Offset of field: OBDisparityParam::disp_offset"]
        [::std::mem::offset_of!(OBDisparityParam, disp_offset) - 38usize];
    ["Offset of field: OBDisparityParam::invalid_disp"]
        [::std::mem::offset_of!(OBDisparityParam, invalid_disp) - 42usize];
    ["Offset of field: OBDisparityParam::disp_int_place"]
        [::std::mem::offset_of!(OBDisparityParam, disp_int_place) - 46usize];
    ["Offset of field: OBDisparityParam::is_dual_camera"]
        [::std::mem::offset_of!(OBDisparityParam, is_dual_camera) - 50usize];
};
#[doc = "@brief disparity parameters for disparity based camera"]
...
const _: () = {
    ...
    ["Offset of field: OBXYTables::x_table"][::std::mem::offset_of!(OBXYTables, x_table) - 0usize];
    ["Offset of field: OBXYTables::y_table"][::std::mem::offset_of!(OBXYTables, y_table) - 8usize];
...
pub struct OBDeviceSyncConfig {
    ...
    pub ir_trigger_signal_in_delay: u16,
    ...
    pub rgb_trigger_signal_in_delay: u16,
    ...
    pub device_trigger_signal_out_delay: u16,
    ...
    pub device_trigger_signal_out_polarity: u16,
...
const _: () = {
    ...
    ["Offset of field: OBDeviceSyncConfig::sync_mode"]
        [::std::mem::offset_of!(OBDeviceSyncConfig, sync_mode) - 0usize];
    ["Offset of field: OBDeviceSyncConfig::ir_trigger_signal_in_delay"]
        [::std::mem::offset_of!(OBDeviceSyncConfig, ir_trigger_signal_in_delay) - 4usize];
    ["Offset of field: OBDeviceSyncConfig::rgb_trigger_signal_in_delay"]
        [::std::mem::offset_of!(OBDeviceSyncConfig, rgb_trigger_signal_in_delay) - 6usize];
    ["Offset of field: OBDeviceSyncConfig::device_trigger_signal_out_delay"]
        [::std::mem::offset_of!(OBDeviceSyncConfig, device_trigger_signal_out_delay) - 8usize];
    ["Offset of field: OBDeviceSyncConfig::device_trigger_signal_out_polarity"]
        [::std::mem::offset_of!(OBDeviceSyncConfig, device_trigger_signal_out_polarity) - 10usize];
    ["Offset of field: OBDeviceSyncConfig::mcu_trigger_frequency"]
        [::std::mem::offset_of!(OBDeviceSyncConfig, mcu_trigger_frequency) - 12usize];
    ["Offset of field: OBDeviceSyncConfig::device_id"]
        [::std::mem::offset_of!(OBDeviceSyncConfig, device_id) - 14usize];
};
#[doc = "@brief Device synchronization configuration\n @deprecated This structure is deprecated, please use @ref ob_multi_device_sync_config instead"]
...
pub struct OBSequenceIdItem {
    pub sequence_select_id: ::std::os::raw::c_int,
...
const _: () = {
    ...
    ["Offset of field: OBSequenceIdItem::sequence_select_id"]
        [::std::mem::offset_of!(OBSequenceIdItem, sequence_select_id) - 0usize];
...
pub struct ob_multi_device_sync_config {
    ...
    pub sync_mode: OBMultiDeviceSyncMode,
    ...
    pub depth_delay_us: ::std::os::raw::c_int,
    ...
    pub color_delay_us: ::std::os::raw::c_int,
    ...
    pub trigger_2_image_delay_us: ::std::os::raw::c_int,
    ...
    pub trigger_out_delay_us: ::std::os::raw::c_int,
    ...
    pub frames_per_trigger: ::std::os::raw::c_int,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ...
    ["Offset of field: ob_multi_device_sync_config::sync_mode"]
        [::std::mem::offset_of!(ob_multi_device_sync_config, sync_mode) - 0usize];
    ["Offset of field: ob_multi_device_sync_config::depth_delay_us"]
        [::std::mem::offset_of!(ob_multi_device_sync_config, depth_delay_us) - 4usize];
    ["Offset of field: ob_multi_device_sync_config::color_delay_us"]
        [::std::mem::offset_of!(ob_multi_device_sync_config, color_delay_us) - 8usize];
    ["Offset of field: ob_multi_device_sync_config::trigger_2_image_delay_us"]
        [::std::mem::offset_of!(ob_multi_device_sync_config, trigger_2_image_delay_us) - 12usize];
    ["Offset of field: ob_multi_device_sync_config::trigger_out_enable"]
        [::std::mem::offset_of!(ob_multi_device_sync_config, trigger_out_enable) - 16usize];
    ["Offset of field: ob_multi_device_sync_config::trigger_out_delay_us"]
        [::std::mem::offset_of!(ob_multi_device_sync_config, trigger_out_delay_us) - 17usize];
    ["Offset of field: ob_multi_device_sync_config::frames_per_trigger"]
        [::std::mem::offset_of!(ob_multi_device_sync_config, frames_per_trigger) - 21usize];
};
#[doc = "@brief The synchronization configuration of the device."]
...
const _: () = {
    ...
    ["Offset of field: AE_ROI::x_0_left"][::std::mem::offset_of!(AE_ROI, x_0_left) - 0usize];
    ["Offset of field: AE_ROI::y_0_top"][::std::mem::offset_of!(AE_ROI, y_0_top) - 2usize];
    ["Offset of field: AE_ROI::x_1_right"][::std::mem::offset_of!(AE_ROI, x_1_right) - 4usize];
    ["Offset of field: AE_ROI::y_1_bottom"][::std::mem::offset_of!(AE_ROI, y_1_bottom) - 6usize];
};
#[doc = "@brief The rect of the region of interest"]
...
pub struct OBDeviceSerialNumber {
    pub number_str: [::std::os::raw::c_char; 16usize],
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ...
    ["Offset of field: OBDeviceSerialNumber::number_str"]
        [::std::mem::offset_of!(OBDeviceSerialNumber, number_str) - 0usize];
};
#[doc = "@brief struct of serial number"]
...
const _: () = {
    ...
    ["Offset of field: OBDispOffsetConfig::offset_0"]
        [::std::mem::offset_of!(OBDispOffsetConfig, offset_0) - 1usize];
    ["Offset of field: OBDispOffsetConfig::offset_1"]
        [::std::mem::offset_of!(OBDispOffsetConfig, offset_1) - 2usize];
...
const _: () = {
    ...
    ["Offset of field: OBHardwareDecimationConfig::origin_width"]
        [::std::mem::offset_of!(OBHardwareDecimationConfig, origin_width) - 0usize];
    ["Offset of field: OBHardwareDecimationConfig::origin_height"]
        [::std::mem::offset_of!(OBHardwareDecimationConfig, origin_height) - 4usize];
